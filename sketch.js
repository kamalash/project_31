...
function preload() {
  ...
  female = loadImage("./assets/femalezombie.png");
...
function setup() {
  ...
  femalezombie = createSprite(width / 35, height - 60, 50, 50);
  femalezombie.addImage("zombie", female);
  femalezombie.scale = 0.1;
  femalezombie.velocityX = 10;
...
function draw() {
  ...
  for (var stone of stones) {
    ...
    var distance = dist(femalezombie.position.x, femalezombie.position.y, pos.x, pos.y);
  ...
  if (femalezombie.position.x >= width - 300 && !collided) {
    femalezombie.velocityX = -10;
    //zombie.changeAnimation("righttoleft");
  }

  if (femalezombie.position.x <= 300 && !collided) {
    femalezombie.velocityX = 10;
    //zombie.changeAnimation("lefttoright");
  }
